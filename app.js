const FOODS = [
  ...
  {
    id: "mos-mos-burger-beef",
    zh: "摩斯 摩斯漢堡(牛)",
    en: "MOS Burger (beef)",
    aliases: ["摩斯漢堡", "mos burger", "牛肉堡"],
    category: "摩斯漢堡",
    carbs: 21.1,
    gi: 72,
    giDisplay: "估 72",
    speed: "fast",
    servingG: 180,
    note: "官方數值:1 個 433.9 kcal、碳水 38.0 g、蛋白質 17.8 g、脂肪 23.5 g;白麵包是主要升糖來源。",
    carbSource: "摩斯漢堡官方營養標示",
    giSource: "白麵包混合餐估算",
  },
  {
    id: "mos-genki-beef-pearl",
    zh: "摩斯 元氣牛肉珍珠堡",
    en: "MOS Genki beef pearl rice burger",
    aliases: ["元氣牛肉珍珠堡", "珍珠堡", "pearl burger"],
    category: "摩斯漢堡",
    carbs: 26.6,
    gi: 80,
    giDisplay: "估 80",
    speed: "fast",
    servingG: 250,
    note: "官方數值:1 個 657.4 kcal、碳水 66.5 g;以白米飯壓成的米漢堡升糖較快。",
    carbSource: "摩斯漢堡官方營養標示",
    giSource: "白米米漢堡估算",
  },
  {
    id: "mos-genki-mori-pearl",
    zh: "摩斯 元氣摩力珍珠堡",
    en: "MOS Genki Mori pearl rice burger",
    aliases: ["元氣摩力珍珠堡", "摩力堡", "豬肉米漢堡"],
    category: "摩斯漢堡",
    carbs: 29.2,
    gi: 80,
    giDisplay: "估 80",
    speed: "fast",
    servingG: 230,
    note: "官方數值:1 個 449.1 kcal、碳水 67.1 g、蛋白質 20.1 g;米漢堡主餐。",
    carbSource: "摩斯漢堡官方營養標示",
    giSource: "白米米漢堡估算",
  },
  {
    id: "mos-lettuce-beef",
    zh: "摩斯 摘鮮綠元氣牛肉堡",
    en: "MOS lettuce-wrapped beef burger",
    aliases: ["摘鮮綠", "生菜堡", "摘鮮綠牛肉堡", "低碳堡"],
    category: "摩斯漢堡",
    carbs: 5.1,
    gi: 30,
    giDisplay: "估 30",
    speed: "slow",
    servingG: 200,
    note: "官方數值:1 個 396.1 kcal、碳水僅 10.1 g、蛋白質 20.3 g;以生菜取代麵包,血糖控制者首選。",
    carbSource: "摩斯漢堡官方營養標示",
    giSource: "生菜包餡低 GI",
  },
  {
    id: "mos-lettuce-mori",
    zh: "摩斯 摘鮮綠元氣摩力堡",
    en: "MOS lettuce-wrapped Mori burger",
    aliases: ["摘鮮綠摩力堡", "生菜摩力堡", "低碳"],
    category: "摩斯漢堡",
    carbs: 7.1,
    gi: 30,
    giDisplay: "估 30",
    speed: "slow",
    servingG: 150,
    note: "官方數值:1 個 203.1 kcal、碳水 10.7 g;低碳水版的摩力堡。",
    carbSource: "摩斯漢堡官方營養標示",
    giSource: "生菜包餡低 GI",
  },
  {
    id: "mos-ocean-pearl",
    zh: "摩斯 海洋珍珠堡",
    en: "MOS ocean pearl rice burger",
    aliases: ["海洋珍珠堡", "鮭魚米漢堡"],
    category: "摩斯漢堡",
    carbs: 32.8,
    gi: 80,
    ...
    speed: "fast",
    servingG: 220,
    note: "官方數值:1 個 403.5 kcal、碳水 72.2 g;每 100g 碳水量在米漢堡中最高。",
    carbSource: "摩斯漢堡官方營養標示",
    giSource: "白米米漢堡估算",
  },
  {
    id: "mos-honey-chicken",
    zh: "摩斯 蜜汁烤雞堡",
    en: "MOS honey-grilled chicken burger",
    aliases: ["蜜汁烤雞堡", "烤雞堡"],
    category: "摩斯漢堡",
    carbs: 19.2,
    gi: 72,
    ...
    speed: "fast",
    servingG: 180,
    note: "官方數值:1 個 383.4 kcal、碳水 34.6 g、蛋白質 18.0 g;白麵包主導。",
    carbSource: "摩斯漢堡官方營養標示",
    giSource: "白麵包混合餐估算",
  },
  {
    id: "mos-cod-burger",
    zh: "摩斯 摩斯鱈魚堡",
    en: "MOS cod fish burger",
    aliases: ["摩斯鱈魚堡", "鱈魚堡", "魚堡"],
    category: "摩斯漢堡",
    carbs: 19.8,
    gi: 72,
    giDisplay: "估 72",
    speed: "fast",
    servingG: 200,
    note: "官方數值:1 個 508.0 kcal、碳水 39.6 g、脂肪 28.7 g;裹粉炸魚加白麵包。",
    carbSource: "摩斯漢堡官方營養標示",
    giSource: "白麵包+炸粉估算",
  },
  {
    id: "mos-shrimp-burger",
    zh: "摩斯 摩斯炸蝦堡",
    en: "MOS shrimp burger",
    aliases: ["炸蝦堡", "蝦堡"],
    category: "摩斯漢堡",
    carbs: 24.6,
    gi: 72,
    ...
    speed: "fast",
    servingG: 180,
    note: "官方數值:1 個 353.0 kcal、碳水 44.2 g;白麵包加裹粉炸蝦。",
    carbSource: "摩斯漢堡官方營養標示",
    giSource: "白麵包+炸粉估算",
  },
  {
    ...
    speed: "fast",
    servingG: 180,
    note: "官方數值:1 個 336.2 kcal、碳水 42.4 g;炸豬排加白麵包。",
    carbSource: "摩斯漢堡官方營養標示",
    giSource: "白麵包+炸粉估算",
  },
  {
    ...
    speed: "fast",
    servingG: 130,
    note: "官方數值:1 個 278.4 kcal、碳水 31.1 g;白麵包加加工肉。",
    carbSource: "摩斯漢堡官方營養標示",
    giSource: "白麵包主導",
  },
  {
    id: "mos-bacon-egg",
    zh: "摩斯 培根雞蛋堡",
    en: "MOS bacon egg burger",
    aliases: ["培根雞蛋堡", "培根蛋堡", "早餐"],
    category: "摩斯漢堡",
    carbs: 18.5,
    gi: 72,
    giDisplay: "估 72",
    speed: "fast",
    servingG: 150,
    note: "官方數值:1 個 410.7 kcal、碳水 27.7 g、脂肪 25.9 g;早餐選項。",
    carbSource: "摩斯漢堡官方營養標示",
    giSource: "白麵包主導",
  },
  {
    id: "mos-ham-omelet",
    zh: "摩斯 火腿歐姆蛋堡",
    en: "MOS ham omelet burger",
    aliases: ["火腿歐姆蛋堡", "歐姆蛋堡", "早餐"],
    category: "摩斯漢堡",
    carbs: 18.4,
    gi: 72,
    giDisplay: "估 72",
    speed: "fast",
    servingG: 140,
    note: "官方數值:1 個 309.6 kcal、碳水 25.8 g;早餐選項,蛋白質較高。",
    carbSource: "摩斯漢堡官方營養標示",
    giSource: "白麵包主導",
  },
  {
    id: "mos-bagel-jam",
    zh: "摩斯 摩斯貝果(草莓醬)",
    en: "MOS bagel with strawberry jam",
    aliases: ["摩斯貝果", "貝果", "草莓醬貝果"],
    category: "摩斯漢堡",
    carbs: 49.7,
    gi: 75,
    giDisplay: "估 75",
    speed: "fast",
    servingG: 100,
    note: "官方數值:1 個 247.0 kcal、碳水 49.7 g;貝果本身碳水密度高,加草莓醬糖更多。",
    carbSource: "摩斯漢堡官方營養標示",
    giSource: "Sydney GI: bagel",
  },
  {
    ...
    speed: "fast",
    servingG: 150,
    note: "官方數值:1 個 517.8 kcal、碳水 53.0 g、脂肪 24.5 g;貝果+培根+蛋。",
    carbSource: "摩斯漢堡官方營養標示",
    giSource: "Sydney GI: bagel",
  },
  {
    id: "mos-ham-egg-sandwich",
    zh: "摩斯 火腿蛋三明治",
    en: "MOS ham egg sandwich",
    aliases: ["火腿蛋三明治", "三明治"],
    category: "摩斯漢堡",
    carbs: 21.8,
    gi: 72,
    ...
    speed: "fast",
    servingG: 180,
    note: "官方數值:1 個 423.0 kcal、碳水 39.3 g。改亞麻玄米吐司版:35.8 g。",
    carbSource: "摩斯漢堡官方營養標示",
    giSource: "白麵包主導",
  },
  {
    id: "mos-chicken-sandwich",
    zh: "摩斯 雞肉三明治",
    en: "MOS chicken sandwich",
    aliases: ["雞肉三明治", "三明治"],
    category: "摩斯漢堡",
    carbs: 23.0,
    gi: 72,
    ...
    speed: "fast",
    servingG: 180,
    note: "官方數值:1 個 355.0 kcal、碳水 41.4 g。亞麻玄米吐司版:36.4 g。",
    carbSource: "摩斯漢堡官方營養標示",
    giSource: "白麵包主導",
  },
  {
    ...
    speed: "fast",
    servingG: 130,
    note: "官方數值:1 份 455.6 kcal、碳水 50.6 g、脂肪 26.2 g。",
    carbSource: "摩斯漢堡官方營養標示",
    giSource: "Sydney GI: fries",
  },
  {
    id: "mos-sweet-potato-fries",
    zh: "摩斯 黃金地瓜薯條",
    en: "MOS sweet potato fries",
    aliases: ["黃金地瓜薯條", "地瓜薯條"],
    category: "摩斯漢堡",
    carbs: 46.4,
    gi: 75,
    ...
    speed: "fast",
    servingG: 130,
    note: "官方數值:1 份 517.6 kcal、碳水 60.3 g;比一般薯條碳水密度更高。",
    carbSource: "摩斯漢堡官方營養標示",
    giSource: "炸地瓜估算",
  },
  {
    ...
    speed: "fast",
    servingG: 90,
    note: "官方數值:1 份 301.2 kcal、碳水 28.8 g。",
    carbSource: "摩斯漢堡官方營養標示",
    giSource: "Sydney GI: fries",
  },
  {
    ...
    speed: "medium",
    servingG: 90,
    note: "官方數值:6 個 289.7 kcal、碳水 13.6 g、蛋白質 19.4 g;主要在裹粉。",
    carbSource: "摩斯漢堡官方營養標示",
    giSource: "炸粉估算",
  },
  {
    id: "mos-japanese-fried-chicken",
    zh: "摩斯 和風炸雞",
    en: "MOS Japanese fried chicken",
    aliases: ["和風炸雞", "唐揚雞"],
    category: "摩斯漢堡",
    carbs: 17.6,
    gi: 55,
    ...
    speed: "medium",
    servingG: 180,
    note: "官方數值:1 份 563.6 kcal、碳水 31.7 g、蛋白質 22.1 g。",
    carbSource: "摩斯漢堡官方營養標示",
    giSource: "炸粉估算",
  },
  {
    ...
    speed: "fast",
    servingG: 350,
    note: "官方數值:1 杯 297.9 kcal、碳水 52.4 g;糖量高,屬點心類飲品。",
    carbSource: "摩斯漢堡官方營養標示",
    giSource: "糖+可可粉估算",
  },
  {
    id: "mos-iced-black-tea-l",
    zh: "摩斯 冰紅茶(L 加糖)",
    en: "MOS iced black tea L",
    aliases: ["摩斯冰紅茶", "紅茶"],
    category: "摩斯漢堡",
    carbs: 5.5,
    gi: 70,
    ...
    speed: "fast",
    servingG: 500,
    note: "官方數值:L 杯 154 kcal、碳水 27.3 g。無糖版只有 1.2 g。",
    carbSource: "摩斯漢堡官方營養標示",
    giSource: "蔗糖估算",
  },
  {
    id: "mos-soy-milk-unsweet",
    zh: "摩斯 豆奶(無加糖)",
    en: "MOS unsweetened soy milk",
    aliases: ["摩斯豆奶", "無糖豆漿"],
    category: "摩斯漢堡",
    carbs: 1.1,
    gi: 30,
    ...
    speed: "slow",
    servingG: 300,
    note: "官方數值:1 杯 88 kcal、碳水 3.2 g、蛋白質 8.0 g;低升糖早餐飲品。",
    carbSource: "摩斯漢堡官方營養標示",
    giSource: "Sydney GI: soy milk",
  },
  {
    ...
    speed: "medium",
    servingG: 240,
    note: "官方數值:1 碗 152.9 kcal、碳水 21.8 g;濃湯有勾芡。",
    carbSource: "摩斯漢堡官方營養標示",
    giSource: "勾芡+玉米估算",
  },
  {
    id: "mwd-plain-egg-pancake",
    zh: "麥味登 原味蛋餅",
    en: "MWD plain egg pancake",
    aliases: ["麥味登蛋餅", "原味蛋餅"],
    category: "麥味登",
    carbs: 11.8,
    gi: 70,
    ...
    speed: "fast",
    servingG: 110,
    note: "官方:1 份 195 kcal、碳水 13 g、蛋白質 13 g;白麵粉皮加蛋。(官網脂肪欄位顯示 50 g 應為標示錯誤)",
    carbSource: "麥味登官方營養標示",
    giSource: "白麵粉皮估算",
  },
  {
    id: "mwd-tuna-egg-pancake",
    zh: "麥味登 鮪魚蛋餅",
    en: "MWD tuna egg pancake",
    aliases: ["鮪魚蛋餅"],
    category: "麥味登",
    carbs: 10.8,
    gi: 70,
    ...
    speed: "fast",
    servingG: 120,
    note: "官方:1 份 196 kcal、碳水 13 g、蛋白質 13 g。",
    carbSource: "麥味登官方營養標示",
    giSource: "白麵粉皮估算",
  },
  {
    id: "mwd-veg-corn-pancake",
    zh: "麥味登 鮮蔬玉米蛋餅",
    en: "MWD veggie corn egg pancake",
    aliases: ["鮮蔬玉米蛋餅", "玉米蛋餅"],
    category: "麥味登",
    carbs: 12.3,
    gi: 70,
    ...
    speed: "fast",
    servingG: 130,
    note: "官方:1 份 208 kcal、碳水 16 g、蛋白質 14 g。",
    carbSource: "麥味登官方營養標示",
    giSource: "白麵粉皮估算",
  },
  {
    id: "mwd-ham-hash-burger",
    zh: "麥味登 火腿薯餅滿分堡",
    en: "MWD ham hash brown burger",
    aliases: ["火腿薯餅滿分堡", "薯餅堡", "滿分堡"],
    category: "麥味登",
    carbs: 18.8,
    gi: 75,
    giDisplay: "估 75",
    speed: "fast",
    servingG: 170,
    note: "官方:1 份 444 kcal、碳水 32 g、脂肪 18 g、鈉 910 mg;漢堡麵包加薯餅雙重澱粉。",
    carbSource: "麥味登官方營養標示",
    giSource: "白麵包+薯餅估算",
  },
  {
    id: "mwd-omelet-danish",
    zh: "麥味登 歐姆蛋丹麥堡",
    en: "MWD omelet Danish burger",
    aliases: ["歐姆蛋丹麥堡", "丹麥堡"],
    category: "麥味登",
    carbs: 26.4,
    gi: 75,
    ...
    speed: "fast",
    servingG: 140,
    note: "官方:1 份 459 kcal、碳水 37 g、脂肪 29 g;丹麥麵包酥皮油脂高。",
    carbSource: "麥味登官方營養標示",
    giSource: "丹麥酥皮估算",
  },
  {
    ...
    speed: "fast",
    servingG: 140,
    note: "官方:1 份 402 kcal、碳水 39 g。蛋白質僅 6 g,屬於碳水主導餐。",
    carbSource: "麥味登官方營養標示",
    giSource: "丹麥酥皮估算",
  },
  {
    id: "mwd-peanut-beef-cheese-burger",
    zh: "麥味登 花生厚牛起司滿分堡",
    en: "MWD peanut beef cheese burger",
    aliases: ["花生厚牛起司滿分堡", "厚牛堡"],
    category: "麥味登",
    carbs: 20.6,
    gi: 72,
    giDisplay: "估 72",
    speed: "fast",
    servingG: 180,
    note: "官方:1 份 406 kcal、碳水 37 g、蛋白質 21 g;花生醬加糖。",
    carbSource: "麥味登官方營養標示",
    giSource: "白麵包+花生醬估算",
  },
  {
    ...
    speed: "fast",
    servingG: 140,
    note: "官方:1 份 208 kcal、碳水 39 g;在來米粉煎製,升糖較快。",
    carbSource: "麥味登官方營養標示",
    giSource: "Sydney GI: rice cake",
  },
  {
    id: "mwd-smoked-chicken-salad",
    zh: "麥味登 燻雞沙拉",
    en: "MWD smoked chicken salad",
    aliases: ["燻雞沙拉"],
    category: "麥味登",
    carbs: 5.3,
    gi: 30,
    ...
    speed: "slow",
    servingG: 150,
    note: "官方:1 份 137 kcal、碳水 8 g、蛋白質 12 g;低升糖餐選項,沙拉醬糖分要注意。",
    carbSource: "麥味登官方營養標示",
    giSource: "蔬菜+蛋白為主",
  },
  {
    id: "mwd-pork-protein-burger",
    zh: "麥味登 黑胡椒豬里肌起司蛋白堡",
    en: "MWD black pepper pork protein burger",
    aliases: ["蛋白堡", "黑胡椒豬里肌蛋白堡", "豬里肌蛋白堡"],
    category: "麥味登",
    carbs: 5.0,
    gi: 35,
    giDisplay: "估 35",
    speed: "slow",
    servingG: 140,
    note: "官方:1 份 246 kcal、碳水 7 g、蛋白質 29 g;蛋白磚取代麵包,血糖控制者推薦。",
    carbSource: "麥味登官方營養標示",
    giSource: "蛋白磚低 GI",
  },
  {
    id: "mwd-chicken-protein-burger",
    zh: "麥味登 原塊嫩雞起司蛋白堡",
    en: "MWD whole chicken protein burger",
    aliases: ["原塊嫩雞蛋白堡", "嫩雞蛋白堡"],
    category: "麥味登",
    carbs: 5.3,
    gi: 35,
    giDisplay: "估 35",
    speed: "slow",
    servingG: 150,
    note: "官方:1 份 296 kcal、碳水 8 g、蛋白質 43 g;高蛋白低碳早餐。",
    carbSource: "麥味登官方營養標示",
    giSource: "蛋白磚低 GI",
  },
  {
    id: "mwd-chicken-protein-set",
    zh: "麥味登 原塊嫩雞蛋白特餐",
    en: "MWD whole chicken protein set",
    aliases: ["原塊嫩雞蛋白特餐", "蛋白特餐"],
    category: "麥味登",
    carbs: 11.5,
    gi: 50,
    giDisplay: "估 50",
    speed: "slow",
    servingG: 200,
    note: "官方:1 份 353 kcal、碳水 23 g、蛋白質 41 g;含蛋白堡與配菜。",
    carbSource: "麥味登官方營養標示",
    giSource: "綜合餐估算",
  },
  {
    id: "mwd-sweet-potato-protein-set",
    zh: "麥味登 元氣地瓜蛋白特餐",
    en: "MWD sweet potato protein set",
    aliases: ["元氣地瓜蛋白特餐", "地瓜蛋白特餐"],
    category: "麥味登",
    carbs: 17.6,
    gi: 65,
    giDisplay: "估 65",
    speed: "medium",
    servingG: 250,
    note: "官方:1 份 314 kcal、碳水 44 g、蛋白質 24 g;碳水主要來自地瓜。",
    carbSource: "麥味登官方營養標示",
    giSource: "地瓜+綜合餐估算",
  },
  {
    id: "laya-cheese-beef-burger",
    zh: "拉亞 起司厚牛漢堡",
    en: "Laya cheese beef burger",
    aliases: ["拉亞起司厚牛", "起司厚牛堡"],
    category: "拉亞漢堡",
    carbs: 22.4,
    gi: 72,
    giDisplay: "估 72",
    speed: "fast",
    servingG: 170,
    note: "官方僅公布熱量 420 kcal;碳水以白麵包+牛肉餅推估約 38 g。",
    carbSource: "拉亞官方熱量+估算",
    giSource: "白麵包主導估算",
  },
  {
    id: "laya-cheese-cod-burger",
    zh: "拉亞 起司鱈魚漢堡",
    en: "Laya cheese cod burger",
    aliases: ["起司鱈魚堡", "鱈魚堡"],
    category: "拉亞漢堡",
    carbs: 21.9,
    gi: 72,
    ...
    speed: "fast",
    servingG: 160,
    note: "官方僅公布熱量 370 kcal;碳水以白麵包+裹粉魚排推估約 35 g。",
    carbSource: "拉亞官方熱量+估算",
    giSource: "白麵包+炸粉估算",
  },
  {
    id: "laya-shrimp-burger",
    zh: "拉亞 海味蝦排堡",
    en: "Laya shrimp patty burger",
    aliases: ["海味蝦排", "蝦排堡"],
    category: "拉亞漢堡",
    carbs: 22.4,
    gi: 72,
    ...
    speed: "fast",
    servingG: 170,
    note: "官方僅公布熱量 436 kcal;碳水推估約 38 g,主要在麵包與裹粉。",
    carbSource: "拉亞官方熱量+估算",
    giSource: "白麵包+炸粉估算",
  },
  {
    id: "laya-grilled-chicken-burger",
    zh: "拉亞 烙烤雞腿堡",
    en: "Laya grilled chicken thigh burger",
    aliases: ["烙烤雞腿堡", "烙烤雞腿"],
    category: "拉亞漢堡",
    carbs: 18.8,
    gi: 72,
    ...
    speed: "fast",
    servingG: 160,
    note: "官方僅公布熱量 354 kcal;雞腿沒裹粉,碳水主要在麵包約 30 g。",
    carbSource: "拉亞官方熱量+估算",
    giSource: "白麵包主導估算",
  },
  {
    id: "laya-mcd-style-chicken",
    zh: "拉亞 麥香雞堡",
    en: "Laya crispy chicken burger",
    aliases: ["麥香雞堡"],
    category: "拉亞漢堡",
    carbs: 24.6,
    gi: 72,
    ...
    speed: "fast",
    servingG: 130,
    note: "官方僅公布熱量 377 kcal;碳水以白麵包+炸雞推估約 32 g。",
    carbSource: "拉亞官方熱量+估算",
    giSource: "白麵包+炸粉估算",
  },
  {
    id: "laya-xl-crispy",
    zh: "拉亞 XL 卡啦炸雞堡",
    en: "Laya XL crispy chicken burger",
    aliases: ["XL卡啦炸雞堡", "卡啦炸雞"],
    category: "拉亞漢堡",
    carbs: 17.9,
    gi: 72,
    giDisplay: "估 72",
    speed: "fast",
    servingG: 280,
    note: "官方僅公布熱量 898 kcal;超大炸雞排碳水推估約 50 g,熱量主要在油脂。",
    carbSource: "拉亞官方熱量+估算",
    giSource: "白麵包+炸粉估算",
  },
  {
    id: "laya-xl-spicy",
    zh: "拉亞 XL 勁辣炸雞堡",
    en: "Laya XL spicy crispy chicken",
    aliases: ["XL勁辣炸雞堡", "勁辣炸雞"],
    category: "拉亞漢堡",
    carbs: 18.8,
    gi: 72,
    giDisplay: "估 72",
    speed: "fast",
    servingG: 240,
    note: "官方僅公布熱量 685 kcal;碳水推估約 45 g。",
    carbSource: "拉亞官方熱量+估算",
    giSource: "白麵包+炸粉估算",
  },
  {
    id: "laya-pork-bagel",
    zh: "拉亞 厚切里肌貝果",
    en: "Laya thick pork loin bagel",
    aliases: ["厚切里肌貝果", "豬里肌貝果"],
    category: "拉亞漢堡",
    carbs: 40.0,
    gi: 75,
    giDisplay: "估 75",
    speed: "fast",
    servingG: 130,
    note: "官方僅公布熱量 372 kcal;貝果本身碳水密度高,推估約 52 g。",
    carbSource: "拉亞官方熱量+估算",
    giSource: "Sydney GI: bagel",
  },
  {
    ...
    speed: "fast",
    servingG: 150,
    note: "官方僅公布熱量 427 kcal;碳水推估約 52 g,主要來自貝果。",
    carbSource: "拉亞官方熱量+估算",
    giSource: "Sydney GI: bagel",
  },
  {
    id: "laya-plain-bagel",
    zh: "拉亞 原味乳酪貝果",
    en: "Laya plain cream cheese bagel",
    aliases: ["原味乳酪貝果", "乳酪貝果"],
    category: "拉亞漢堡",
    carbs: 48.0,
    gi: 75,
    ...
    speed: "fast",
    servingG: 100,
    note: "官方僅公布熱量 274 kcal;貝果加奶油乳酪,碳水推估約 48 g。",
    carbSource: "拉亞官方熱量+估算",
    giSource: "Sydney GI: bagel",
  },
  {
    id: "laya-cheese-pancake",
    zh: "拉亞 起司蛋餅",
    en: "Laya cheese egg pancake",
    aliases: ["拉亞起司蛋餅", "起司蛋餅"],
    category: "拉亞漢堡",
    carbs: 21.5,
    gi: 70,
    ...
    speed: "fast",
    servingG: 130,
    note: "官方僅公布熱量 363 kcal;碳水推估約 28 g,主要在蛋餅皮。",
    carbSource: "拉亞官方熱量+估算",
    giSource: "白麵粉皮估算",
  },
  {
    ...
    speed: "fast",
    servingG: 150,
    note: "官方僅公布熱量 430 kcal;碳水推估約 30 g。",
    carbSource: "拉亞官方熱量+估算",
    giSource: "白麵粉皮估算",
  },
  {
    id: "laya-bacon-pancake",
    zh: "拉亞 培根蛋餅",
    en: "Laya bacon egg pancake",
    aliases: ["培根蛋餅"],
    category: "拉亞漢堡",
    carbs: 20.0,
    gi: 70,
    ...
    speed: "fast",
    servingG: 140,
    note: "官方僅公布熱量 464 kcal;熱量高主要在培根油脂,碳水推估約 28 g。",
    carbSource: "拉亞官方熱量+估算",
    giSource: "白麵粉皮估算",
  },
  {
    id: "laya-corn-pancake",
    zh: "拉亞 玉米蛋餅",
    en: "Laya corn egg pancake",
    aliases: ["玉米蛋餅"],
    category: "拉亞漢堡",
    carbs: 21.4,
    gi: 70,
    ...
    speed: "fast",
    servingG: 140,
    note: "官方僅公布熱量 356 kcal;碳水推估約 30 g。",
    carbSource: "拉亞官方熱量+估算",
    giSource: "白麵粉皮估算",
  },
  {
    id: "laya-tuna-salad-pancake",
    zh: "拉亞 鮪魚沙拉蛋餅",
    en: "Laya tuna salad egg pancake",
    aliases: ["鮪魚沙拉蛋餅", "鮪魚蛋餅"],
    category: "拉亞漢堡",
    carbs: 20.0,
    gi: 70,
    ...
    speed: "fast",
    servingG: 150,
    note: "官方僅公布熱量 412 kcal;碳水推估約 30 g,沙拉醬糖分另計。",
    carbSource: "拉亞官方熱量+估算",
    giSource: "白麵粉皮估算",
  },
  {
    id: "laya-pork-floss-pancake",
    zh: "拉亞 肉鬆蛋餅",
    en: "Laya pork floss egg pancake",
    aliases: ["肉鬆蛋餅"],
    category: "拉亞漢堡",
    carbs: 21.4,
    gi: 72,
    ...
    speed: "fast",
    servingG: 140,
    note: "官方僅公布熱量 496 kcal;碳水推估約 30 g,肉鬆含糖。",
    carbSource: "拉亞官方熱量+估算",
    giSource: "白麵粉皮+糖估算",
  },
  {
    ...
    speed: "fast",
    servingG: 500,
    note: "官方:500cc 315 kcal、糖 26 g;一杯約 63 g 碳水。",
    carbSource: "拉亞官方標示",
    giSource: "蔗糖+奶精估算",
  },
  {
    ...
    speed: "slow",
    servingG: 400,
    note: "官方:400cc 0 kcal、糖 0 g;血糖控制者的安全選擇。",
    carbSource: "拉亞官方標示",
    giSource: "無糖",
  },
  {
    ...
    speed: "slow",
    servingG: 400,
    note: "官方:400cc 99 kcal、糖 7.2 g;主要碳水來自牛奶乳糖。",
    carbSource: "拉亞官方標示",
    giSource: "乳糖估算",
  },
];
...
function getLastPortion(id) {
  ...
  return Number(FOOD_BY_ID[id]?.servingG) || 100;
}
